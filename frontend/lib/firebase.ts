...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "AIzaSyDummyKeyForBuildSafety00000000",
...
// Initialize Firebase singleton (with fallback values for static build safety)
